...
def train_loop(config, msg="default"):
    ...
    num_inputs = np.prod(env.observation_space.shape) #env.observation_space.shape[0]
    ...
    for i_episode in itertools.count(1):
        ...
        while not done:
            ...
            ret = env.step(action)
            if len(ret) == 4:
                next_state, reward, done, info = ret  # Step
            elif len(ret) == 5:
                next_state, reward, done, truncated, info = ret  # Step
